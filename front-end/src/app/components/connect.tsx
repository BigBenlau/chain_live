...
function Connect({ onClose }: ConnectProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="relative bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="absolute top-4 right-4 z-10 p-2 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white transition-colors"
            aria-label="关闭"
          >
        ...
        <div className="p-6 md:p-8">
          <div className={`grid ${isConnected ? 'grid-cols-1' : 'grid-cols-1 lg:grid-cols-2'} gap-8`}>
            {/* 连接状态卡片 */}
                ...
                <div className="space-y-4 mb-8">
                  {connectors.map((connector) => (
                    <button
                      ...
                      className="w-full p-4 border-2 border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-500 rounded-xl transition duration-200 flex items-center justify-between group hover:bg-blue-50 dark:hover:bg-blue-900/20 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
